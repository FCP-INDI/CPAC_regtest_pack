...
from summary_app.correlations import compare_pipelines
from summary_app.correlations.utils import read_yml_file
from flask import Blueprint

correlations = Blueprint('correlations', __name__)
